...
Tags: testimonials, clients, visual composer, flat design, grid, responsive, reviews, rich snippets, seo, slider, star rating
...
Looking for the best WordPress Testimonials Plugin? Only a few minutes to set up, and it is fully compatible with visual composer. It is 100% FREE.    

== Description ==

***Please email us at hello@adoncreatives.net and let us know of any problem and we will sort it out. Thank you!***
...
4. (Make your instructions match the desired user flow for activating and installing your plugin. 
5. Navigate to Testimonials on the WordPress back-end and create your first testimonial
...
= 1.2 =
* Shortcode preview now working .Fixed the issue where it was loading but not showing the preview
* Now fully compatible with Visual Composer page builder plugin
* Updated readme.txt
